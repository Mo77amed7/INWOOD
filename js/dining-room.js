fetch("js/all-products.json")
  ...
  .then((data) => {
    const diningroomProducts = data.diningRooms;
    displayProducts(diningroomProducts, "diningrooms");
  })
  .catch((error) => console.error("Error fetching data:", error));


function displayProducts(products, diningrooms) {
  const productsDiv = document.getElementById(diningrooms);
